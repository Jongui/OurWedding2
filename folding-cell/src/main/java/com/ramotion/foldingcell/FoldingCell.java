...
import joaogd53.com.br.ViewHeightToSmall;
...
//        } catch (ViewHeightToSmall ex) {
//            this.resize();
//            this.toggle(skipAnimation);
//        }
    }
    ...
    public void resize() {
        ...
        if (titleView == null) return;
        int newHeight = titleView.getHeight() * 2;
        ViewGroup.LayoutParams params = contentView.getLayoutParams();
        params.height = newHeight;
        contentView.requestLayout();
        newHeight = contentView.getHeight();
        Log.d("Height", "Height: " + newHeight);
    }
...
//            throw new ViewHeightToSmall("Content View height is too small");
